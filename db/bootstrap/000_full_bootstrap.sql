...
-- ===== products (3행) =====
-- products_image_required: ACTIVE 상품은 image_url 필수 (039). NULL 시드/덮어쓰기 금지.
INSERT INTO public.products (id, seller_id, name, description, price, image_url, status, created_at, updated_at) VALUES ('0af19d5b-6957-4635-bbdf-02bd24430d64', NULL, '마사지볼 듀오', '작은 부위 이완과 셀프 케어에 활용할 수 있는 마사지볼 세트입니다.', '15000', 'https://ubylshiqilznifpmbkyu.supabase.co/storage/v1/object/public/images/products/aa4ae407-4370-49b8-9e15-6ff8a87e88af.png', 'ACTIVE', '2026-05-06T04:09:46.794Z', '2026-05-06T04:09:46.794Z')
  ON CONFLICT (id) DO UPDATE SET seller_id = EXCLUDED.seller_id, name = EXCLUDED.name, description = EXCLUDED.description, price = EXCLUDED.price, image_url = COALESCE(EXCLUDED.image_url, public.products.image_url), status = EXCLUDED.status, created_at = EXCLUDED.created_at, updated_at = EXCLUDED.updated_at;
INSERT INTO public.products (id, seller_id, name, description, price, image_url, status, created_at, updated_at) VALUES ('2fe18664-5b24-4bb3-9ce7-21b4bf1f78c3', NULL, '밸런스 스트레칭 밴드', '15분 케어 루틴에서 움직임 범위를 확인하기 좋은 밴드입니다.', '19000', 'https://ubylshiqilznifpmbkyu.supabase.co/storage/v1/object/public/images/products/a10878e3-5d0c-4e46-b798-4f1351a8a2be.png', 'ACTIVE', '2026-05-06T04:09:46.794Z', '2026-05-06T04:09:46.794Z')
  ON CONFLICT (id) DO UPDATE SET seller_id = EXCLUDED.seller_id, name = EXCLUDED.name, description = EXCLUDED.description, price = EXCLUDED.price, image_url = COALESCE(EXCLUDED.image_url, public.products.image_url), status = EXCLUDED.status, created_at = EXCLUDED.created_at, updated_at = EXCLUDED.updated_at;
INSERT INTO public.products (id, seller_id, name, description, price, image_url, status, created_at, updated_at) VALUES ('c524008b-0acf-4b1d-9385-96cf1aa46c13', NULL, 'MEBODY 폼롤러', '목·어깨·골반 루틴 전후에 쓰기 좋은 기본 회복 도구입니다.', '29000', 'https://ubylshiqilznifpmbkyu.supabase.co/storage/v1/object/public/images/products/c3832d4b-9f9d-476e-96c9-7d418e84ebd4.png', 'ACTIVE', '2026-05-06T04:09:46.794Z', '2026-05-06T04:09:46.794Z')
  ON CONFLICT (id) DO UPDATE SET seller_id = EXCLUDED.seller_id, name = EXCLUDED.name, description = EXCLUDED.description, price = EXCLUDED.price, image_url = COALESCE(EXCLUDED.image_url, public.products.image_url), status = EXCLUDED.status, created_at = EXCLUDED.created_at, updated_at = EXCLUDED.updated_at;
...
-- ===== body_code_content identity/share/care (from 046) =====
