...
export const RESULT_GUIDE_SECTIONS: { title: string; content: string }[] = [
  {
    title: '핵심 원칙',
    content: '완벽한 자세보다 중요한 건, 나쁜 자세를 안 하는 것이 아니라 **오래 머무르지 않는 것**입니다. 우리는 로봇이 아니기 때문에 자세가 흐트러질 수 있습니다. 괜찮습니다. 중요한 건 "지금 내가 이렇게 앉아/서 있구나" 하고 알아차리는 것입니다. 같은 자세를 오래 반복하면 몸의 조직이 늘어난 상태로 굳어질 수 있어요. (= 크리프 Creep 현상)',
  },
  {
